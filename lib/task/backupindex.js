                ...
                //  console.log('twitterDetails--',twitterDetails)
                    if(twitterDetails !== null)
                    {
                      ...
                      if(userTimelineStatus[0].user.description != twitterDetails.twitbio)
                      {
                        ...
                        notify(headers, userTimelineStatus[0], config, null, userTimelineStatus[0].user.description,null,null);
                      ...
                      if(userTimelineStatus[0].user.url != twitterDetails.twiturl)
                      {
                        ...
                        notify(headers, userTimelineStatus[0], config, null, null,null,userTimelineStatus[0].user.url);
                     ...
                     // console.log('userTimelineStatus[0].user.followers_count--',userTimelineStatus[0].user)
                        ...
                        )
                      {
                        ...
                        notify(headers, userTimelineStatus[0], config, null, null,'twitfollower',null);
                      ...
                      if (userTimelineStatus[0].entities.media) {
                        notify(headers, userTimelineStatus[0], config, userTimelineStatus[0].entities.media[0].media_url,null,null,null);

                      }else{

                          notify(headers, userTimelineStatus[0], config,null,null,null,null);
